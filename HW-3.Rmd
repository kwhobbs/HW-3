...
p_hat <- predict(predict_sex_model, data=training, type="response")
...
The model performed better on the test data, but only marginally! 63.4% of predictions were correct for the test data, while 63.3% were correct for the training data. 
...
p <- ggplot() +
  ...
  labs(x='Date', y='USD') +
  labs(title="Value of Bitcoin and Gold 2010-2016")

p

#I still need to figure out how to make a variable for daily change in price. I know how I would do this in excel by taking the difference between one cell and the cell before it, but need to figure out the command in R. 
